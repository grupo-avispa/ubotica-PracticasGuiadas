...
#define BDC_MCPWM_GPIO_A              (gpio_num_t)CONFIG_BDC_MCPWM_GPIO_A
#define BDC_MCPWM_GPIO_B              (gpio_num_t)CONFIG_BDC_MCPWM_GPIO_B

#define BDC_ENCODER_GPIO_A            (gpio_num_t)CONFIG_BDC_ENCODER_GPIO_A
#define BDC_ENCODER_GPIO_B            (gpio_num_t)CONFIG_BDC_ENCODER_GPIO_B
