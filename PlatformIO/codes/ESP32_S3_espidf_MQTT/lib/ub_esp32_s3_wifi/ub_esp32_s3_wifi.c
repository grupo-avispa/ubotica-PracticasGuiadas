...
static esp_netif_t *ub_esp32_s3_wifi_netif = NULL;
...
esp_err_t ub_esp32_s3_wifi_init(void)
{
    ...
    ub_esp32_s3_wifi_netif = esp_netif_create_default_wifi_sta();
    if (ub_esp32_s3_wifi_netif == NULL) {
...
esp_err_t ub_esp32_s3_wifi_deinit(void)
{
    ...
    ESP_ERROR_CHECK(esp_wifi_clear_default_wifi_driver_and_handlers(ub_esp32_s3_wifi_netif));
    esp_netif_destroy(ub_esp32_s3_wifi_netif);
