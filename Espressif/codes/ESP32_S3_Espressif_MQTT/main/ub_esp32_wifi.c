...
{
    esp_log_level_set("ub_WiFi", ESP_LOG_INFO);
    ...
    // ESP_ERROR_CHECK(esp_event_loop_create_default()); // error! Parece que solape, esto ya lo hace el main (línea 251)
